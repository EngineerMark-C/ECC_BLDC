...
const uint8 tld7002_ascii_font_5x7[][7] =
{
    ...
    { 0x1C, 0x22, 0x32, 0x2A, 0x26, 0x22, 0x1C},  // 0 16
     //双闪灯
      { 0x20, 0x30, 0x38, 0x3c, 0x38, 0x30, 0x20},//1
      { 0x00, 0x00, 0x08, 0x08, 0x08, 0x00, 0x00},//2
      { 0x02, 0x06, 0x0e, 0x1e, 0x0e, 0x06, 0x02},//3
      //右转灯
      { 0x20, 0x30, 0x38, 0x3c, 0x38, 0x30, 0x20},//4
      { 0x00, 0x00, 0x3e, 0x3e, 0x3e, 0x00, 0x00},//5
      { 0x00, 0x00, 0x1e, 0x1e, 0x1e, 0x00, 0x00},//6
      //左转灯
      { 0x00, 0x00, 0x3c, 0x3c, 0x3c, 0x00, 0x00},//7
      { 0x00, 0x00, 0x3e, 0x3e, 0x3e, 0x00, 0x00},//8
      { 0x02, 0x06, 0x0e, 0x1e, 0x0e, 0x06, 0x02},//9 这个是从左往右第一个
      //近光灯
      { 0x08, 0x10, 0x28, 0x10, 0x28, 0x10, 0x20},  //   :
      { 0x3c, 0x04, 0x04, 0x04, 0x04, 0x04, 0x3c},//;
      { 0x02, 0x04, 0x08, 0x08, 0x08, 0x04, 0x02},//< 这个是从左往右第一个
      //远光灯
      //在排针多的朝上面
      // 最后一个                             第一个
      ...
      { 0x02, 0x04, 0x08, 0x08, 0x08, 0x04, 0x02},//? 这个是从左往右第一个
      //雾灯
      { 0x10, 0x38, 0x10, 0x38, 0x10, 0x38, 0x10},//@
      { 0x3c, 0x04, 0x04, 0x04, 0x04, 0x04, 0x3c},//A
      { 0x02, 0x04, 0x08, 0x08, 0x08, 0x04, 0x02},//B 这个是从左往右第一个
...
void dot_matrix_screen_init(void)
{
    ...
    //dot_matrix_screen_set_brightness(2000);
    // 清空显示
