...
#define DOT_MATRIX_SCREEN_SYNC_PIN (ERU_CH4_REQ8_P33_7) // 使用P20_9接收同步信号
#define DOT_MATRIX_SCREEN_SR0_PIN (P33_11)
#define DOT_MATRIX_SCREEN_SR1_PIN (P33_10)
#define DOT_MATRIX_SCREEN_SR2_PIN (P33_9)
#define DOT_MATRIX_SCREEN_SR3_PIN (P33_8) // 摩托组可以将引脚定义修改为P33_8
#define DOT_MATRIX_SCREEN_SR4_PIN (P33_6)
#define DOT_MATRIX_SCREEN_SR5_PIN (P33_5)
#define DOT_MATRIX_SCREEN_SR6_PIN (P33_4)
